...
class MySwitch {
	...
	updateHomekit() {
		this.switchService.getCharacteristic(Characteristic.CurrentPosition).updateValue(this.getProgress());
		this.switchService.getCharacteristic(Characteristic.TargetPosition).updateValue(this.getTarget());
	}
